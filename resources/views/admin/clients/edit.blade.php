        ...
        <div class="panel-body">
            ...
            {{--<div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::hidden('location_latitude', $client->location_latitude , ['id' => 'location-latitude']) !!}
                    {!! Form::hidden('location_longitude', $client->location_longitude , ['id' => 'location-longitude']) !!}
                    <p class="help-block"></p>
